...
public class DisplayRegex {
    ...
    public static boolean checkPattern(String expression) throws NullPointerException{
        boolean retVal = expression.matches(DisplayRegex.regex);
        return retVal;
    }

    public void run(String s){
        List<String> contents = null;
        Pattern r = Pattern.compile(DisplayRegex.regex); // Create a Pattern object to compile the regular expression
